...
In this paper, propose the task of detecting logical fallacies in vision-language arguments: Given an argument for a claim using multiple premises, detect its logical fallacies if any.
